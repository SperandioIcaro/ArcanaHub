...
module.exports = {
  ...
  async handleComponent(interaction) {
    if (!interaction.isStringSelectMenu() || !interaction.customId.startsWith('selecionar_ficha:')) return;
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '🧬 Raça', value: ficha.raca + (ficha.subraca && ficha.subraca !== 'Nenhuma' ? ` (${ficha.subraca})` : ''), inline: true },
